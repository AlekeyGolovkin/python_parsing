...
# for storage in range(количество страница): если необходимо скачать все картинки с сайта
...
for image in all_image:
    ...
    image_number += 1
    print(f'картинка {image_number}.jpg скачано')

    # storage_number += 1  переход на некст страницу